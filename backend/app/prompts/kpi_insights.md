...
Then 2 to 4 `findings`. Each has:

- `text` — what happened and which number says so. Name the machine or the
  reason code. One or two sentences.
- `action` — what this supervisor should do about it this morning. Concrete
  and assignable, not "monitor the situation".
